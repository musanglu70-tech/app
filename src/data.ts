...
export const FAQS: FAQ[] = [
  {
    ...
    answer: '네, CSO (주)우리메디텍은 제약 직거래 네트워크 최적화 및 유통 불필요 단계를 줄여 절감된 마진을 파트너(MR)님들과 공유합니다. 타사 대비 평균 1~5% 높은 요율을 안정적으로 보장해 드립니다.'
  },
  {
    id: 'q2',
    category: 'settlement',
    question: '정산 일정 및 신속정산 여부는 어떻게 되나요?',
    answer: '통계 마감 후 매달 제약회사별로 제약사 입금일에 맞춰서 동일한 날짜에 송금해드립니다. 예) 제약사 입금일 1/31 → 1/31일 송금 진행'
  },
  {
    id: 'q4',
    category: 'info',
    question: '초기 파트너 등록 시 어떤 서류가 필요한가요?',
    answer: '개인 또는 법인사업자등록증 사본, 계좌사본, 그리고 CSO신고증이 필요합니다. 상세 가이드는 담당자 상담 후 SMS/카카오톡으로 자동 발송됩니다.'
  }
];
